...
const OfficeAddress = ( { office }) => {
    ...
    const contents = (
        <div className=" md:px-20 md:py-20 flex flex-col">
    ...
    const image = (
        <div className=" bg-cover py-4 md:p-6 h-[400px] "  >
   ...
   second = image
    ...
    return (
        ...
        <div className="flex w-full ">
            <div className=" grid grid-cols-1 :grid-cols-2 w-full md:px-20 px-6 ">
                {first}
                {second}
            </div>
        </div>
