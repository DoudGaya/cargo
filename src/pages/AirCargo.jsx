...
import bannerImg from '../assets/imgs/banner3.jpg';
// import plane from '../../assets/imgs/partners/banner3.jpg'
    ...
    return (
       ...
       <div className=" w-full  md:w-8/12 px-10 md:px-0 py-10 mx-auto">
        <Steps bannerImg={bannerImg} />
            <div className=" dark:text-white py-4 mb-3">
                <h2 className=" text-sky-900 dark:text-sky-100 font-banner font-bold text-xl">The Air Cargo</h2>
            </div>
            <p className="leading-8 dark:text-white text-lg ">
                ...
                Overall, the process of cargo in a logistics and freight forwarding company involves coordinating with various parties and using various tools and resources to ensure the safe and timely delivery of the cargo to its destination.
            </p>

            {/* <h2 className=" uppercase text-xl my-6 underline">How it works </h2> */}
            {/* <p className=" leading-8">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Obcaecati quia neque nostrum voluptate, blanditiis
                fugit quibusdam ratione ullam soluta magni officiis provident voluptatibus quidem cumque maxime tempore
                et eveniet sed totam, eos incidunt? Natus ex sint laudantium, delectus ad minima odio quisquam veniam
                dignissimos officia quasi deserunt dicta voluptatem assumenda sapiente ab modi mollitia. Recusandae
                ea expedita beatae eaque fugit distinctio assumenda impedit officiis, perferendis quaerat aliquam,
                dolores iure, tempore a unde doloremque totam reiciendis sequi eligendi sunt itaque soluta modi placeat magnam? 
                Ullam, delectus minima? Culpa impedit est dolores alias, doloremque exercitationem mollitia error, rerum quaerat
                corrupti reiciendis hic!
            </p>
            <h2 className=" uppercase text-xl my-6 underline">Conclusion</h2>
            <p className=" leading-8">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Obcaecati quia neque nostrum voluptate, blanditiis
                fugit quibusdam ratione ullam soluta magni officiis provident voluptatibus quidem cumque maxime tempore
                et eveniet sed totam, eos incidunt? Natus ex sint laudantium, delectus ad minima odio quisquam veniam
